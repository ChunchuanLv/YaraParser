java -jar  jar/YaraParser.jar train nt:16 -test ../data/test.dep -train-file ../data/train.dep -dev ./data/dev.dep  -model ../data/matModel iter:20 -punc punc_files/wsj.puncs -ce deps.words -depe depsF.dep -repPath ../data  depMat

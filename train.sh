java -jar  jar/YaraParser.jar train nt:16  -input ../data/test.dep -train-file /disk/cohortnas/masters/s1544871/train.dep -dev /disk/cohortnas/masters/s1544871/dev.dep  -model /disk/cohortnas/masters/s1544871/vecModel iter:20 -punc punc_files/wsj.puncs  -repPath ../data  

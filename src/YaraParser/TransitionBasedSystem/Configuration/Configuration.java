...
public class Configuration implements Comparable, Cloneable, Serializable {
	...
	public Configuration(Sentence sentence, boolean rootFirst, boolean dep, boolean depMat) {
	...
	public Configuration(Sentence sentence, boolean dep, boolean depMat) {
		this.sentence = sentence;
	 ...
	 *
	 * @param normalized
	 *            if true, the score will be normalized by the number of done
	 *            actions
	 * @return
	 */
	...
	public Configuration clone() {
		Configuration configuration = new Configuration(sentence, dep, depMat);

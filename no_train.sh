java -jar  jar/YaraParser.jar train -test ../data/test.dep -train-file ../data/train.dep -dev ../data/dev.dep  -model ../data/model/no_model iter:20 -punc punc_files/wsj.puncs

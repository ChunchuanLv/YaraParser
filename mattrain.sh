java -jar  jar/YaraParser.jar train nt:4  -train-file ../data/train.dep -dev ../data/dev.dep  -model ../data/model/matModel iter:20 -punc punc_files/wsj.puncs -depe depsF.dep -repPath ../data  depMat
